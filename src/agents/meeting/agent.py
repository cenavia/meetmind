...
def get_graph() -> StateGraph:
    """Construye y compila el grafo: preprocess → extract_participants → identify_topics → extract_actions → mock_result → END."""
    ...
    graph.add_edge("extract_actions", "mock_result")
